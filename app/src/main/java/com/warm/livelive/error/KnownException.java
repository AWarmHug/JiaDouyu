...
public class KnownException extends Exception {
    ...
    public KnownException(int errorCode) {
        this.errorCode = errorCode;
    }

    public KnownException(int error, String message) {
    ...
    public KnownException(String message, OnErrorListener listener) {
        this(UNIMPORTANT, message, listener);
    }

    public KnownException(String message, String actionName, OnErrorListener listener) {
        this(UNIMPORTANT, message, actionName, listener);
    }


    public KnownException(int errorCode, String message, OnErrorListener listener) {
        this(errorCode, message, null, listener);
    }

    public KnownException(int errorCode, String message, String actionName, OnErrorListener mOnErrorListener) {
        this(errorCode,message,null,actionName, mOnErrorListener);

    }
    public KnownException(int errorCode, String message, ErrorShowInfo errorShowInfo, String actionName, OnErrorListener mOnErrorListener) {
        super(message);
        this.errorCode = errorCode;
        this.errorShowInfo=errorShowInfo;
        this.actionName = actionName;
