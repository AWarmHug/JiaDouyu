...
public class VideoPlayController extends BasePlayController implements BottomBar.OnBottomOperationListener {
    ...
    public VideoPlayController(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VideoPlayController(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected int getLayoutRes() {
        return R.layout.controller_play_video;
    }
